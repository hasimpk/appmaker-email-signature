...
function generateHTML(data: EmailSignatureData): string {
  ...
  const linkedinHtml = data.linkedinProfile
    ? `<table cellpadding="0" cellspacing="0" style="margin-bottom:4px;border-collapse:collapse;display:inline-table;vertical-align:middle"><tr><td style="width:24px;height:24px;padding:0;text-align:center;vertical-align:middle"><img src="https://cms-frontend-api.appmaker.xyz/api/media/file/linkedin-round.png" style="width:24px;height:24px;display:block;margin:0 auto" /></td><td style="padding-left:4px;vertical-align:middle"><a href="${linkedinHref}" target="_blank" style="color:#1a1a2e;text-decoration:none;font-size:12px;font-weight:500;vertical-align:middle">linkedin</a></td></tr></table>`
    : "";
